...
local addrs = {
	ptrRacerData = 0x0217ACF8 + ptrOffset, -- racerData[8]*
	InputUnits = 0x02175608 + ptrOffset, -- input_unit_t[10]
	ptrRaceTimers = 0x0217AA34 + ptrOffset, -- race_state_t*
	ptrMissionInfo = 0x021A9B70 + ptrOffset,
	ObjStuff = 0x0217B588 + ptrOffset,
	racerCount = 0x0217ACF4 + ptrOffset,
	ptrRaceMultiConfig = 0x021759A0 + ptrOffset, -- race_multi_config_t*
	ptrRaceStatus = 0x021755FC + ptrOffset, -- race_status_t*
	ptrMapData = 0x02175600 + ptrOffset, -- mdat_mapdata_t*
	ptrScoreCounters = 0x0217ACFC + ptrOffset, -- score_counters_t*
	collisionData = 0x0217B5F4 + ptrOffset,
	ptrCamera = 0x217AA4C + ptrOffset, -- camera_t*
	ptrVisibilityStuff = 0x217AE90 + ptrOffset,
	ptrBattleController = 0x0217B1DC + ptrOffset, -- mgcnt_t*
	ptrItemInfo = memory.read_u32_le(0x020FA8A4 + ptrOffset), -- it_driver_item_status_t* needs version testing
